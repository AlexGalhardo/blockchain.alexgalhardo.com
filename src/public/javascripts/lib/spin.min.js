    ...
    function l() {
        ...
        p.addRule(".spin-vml", "behavior:url(#default#VML)"),
            (s.prototype.lines = function (t, n) {
                function o() {
                    return r(i("group", { coordsize: d + " " + d, coordorigin: -u + " " + -u }), {
                        width: d,
                        height: d,
                    });
                }
    ...
    (s.defaults = {}),
        o(s.prototype, {
                ...
                if (
                    ...
                    (function h() {
                        ...
                        for (var t = 0; n.lines > t; t++)
                            (a = Math.max(1 - ((s + (n.lines - t) * f) % c) * p, n.opacity)),
            ...
            stop: function () {
                var t = this.el;
                return (
                    t && (clearTimeout(this.timeout), t.parentNode && t.parentNode.removeChild(t), (this.el = void 0)),
                    this
                );
            },
            lines: function (n, o) {
                ...
                for (var l, d = 0, c = ((o.lines - 1) * (1 - o.direction)) / 2; o.lines > d; d++)
                    (l = r(t(), {
                        ...
                        animation:
                            u &&
                            i(o.opacity, o.trail, c + d * o.direction, o.lines) +
                                " " +
                                1 / o.speed +
                                "s linear infinite",
                    })),
